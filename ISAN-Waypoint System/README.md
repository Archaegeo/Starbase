Version 4.0 - ISAN 2.5 + 15 Waypoint System + Ship and Waypoint Heading - Now with Waypoint name parsing and hold increment/decrement to advance fast.
...
4. Install Memory Chip 3.  On it set fields `i`, `j`, `k` to 0, set fields `wp11` to `wp15` to `"wp11 1000 1000 1000"`, `"wp12 1000 1000 1000"`, etc (quotes included). ![MEMORY-CHIP3](images/MemChip3.jpg)
